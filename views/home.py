...
.elegant-header-dark {
    font-family: 'Manrope', sans-serif;  /* ← CAMBIO: era Cormorant */
    color: #ffffff;
    font-size: 3rem;  /* Ajustado ligeramente */
    text-align: center;
    margin-bottom: 50px;
    font-weight: 600;  /* Más pesado en Manrope se ve mejor */
    letter-spacing: 0.5px;  /* Toque de elegancia */
}
...
.step-num {
    ...
    color: #bfa15a;
    font-family: 'Manrope', sans-serif;  /* Ya estaba bien */
    font-weight: 700;
    font-size: 1.8rem;
    width: 80px;
    flex-shrink: 0;
...
.step-title {
    color: #ffffff;
    font-family: 'Manrope', sans-serif;  /* ← CAMBIO: era Cormorant */
    font-weight: 600;  /* En Manrope, 600 da buen peso */
    font-size: 1.3rem;  /* Ajustado para Manrope */
    padding: 25px;
    display: flex;
    align-items: center;
    flex-grow: 1;
...
.step-body {
    ...
    color: #cccccc;
    font-size: 1rem;  /* Manrope se ve mejor un poco más pequeña */
    line-height: 1.8;  /* Manrope necesita más line-height */
    font-family: 'Manrope', sans-serif;  /* ← CAMBIO: era Cormorant */
    text-align: justify;
}
...
.neon-highlight { 
    color: #bfa15a; 
    font-weight: 700;  /* Más peso en Manrope */
}
...
/* ================================================
   ...
   Cubre col1, col2 (botón único) y col3 (doble)
   ================================================ */

/* Wrapper del stButton — sin gaps ni padding */
[data-testid="stHorizontalBlock"] > [data-testid="stColumn"]
...
/* EL BOTÓN REAL — negro dorado en TODOS */
[data-testid="stHorizontalBlock"] > [data-testid="stColumn"]
...
/* ================================================
   CARD 3 — DOBLE BTN: corrige border-radius
   ================================================ */

/* El stHorizontalBlock interior (los 2 sub-cols) */
...
<div class="origen-black-block">
    ...
    <details class="step-item">
        ...
        <div class="step-body">
            Se sustenta en un potente grupo de empresas tractoras y, sobre todo, en una masiva red de industria mediana y familiar de alto rendimiento. Este
ecosistema ofrece un volumen ingente de oportunidades que, por su atomización, 
    ...
    <details class="step-item">
        ...
        <div class="step-body">
            ...
            no act&uacute;a como aval autom&aacute;tico en el ecosistema loca.</span>
            A menudo se desconoce la excelencia y la exigente "escuela de negocio" que hay detrás de estas trayectorias. Lo que en otros hubs globales tiene un efecto multiplicador —
donde unos pocos años de experiencia equivalen a una década en entornos estándar—, en Euskadi requiere de un
interlocutor que traduzca ese valor.
        </div>
    </details>
</div>
""", unsafe_allow_html=True)
