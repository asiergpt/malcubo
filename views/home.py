...
/* ================================================
   MÓVIL / RESPONSIVE (¡AQUÍ ESTÁ LA MAGIA!)
   ================================================ */
@media (max-width: 768px) {
    ...
    .step-body {
        padding: 15px 20px 25px 20px; /* Reducimos el indent izquierdo gigante de 110px */
        font-size: 0.95rem;
    }
    
    /* Arreglar el apilado de columnas de Streamlit */
    [data-testid="stHorizontalBlock"] {
        flex-direction: column !important;
        gap: 20px !important;
    }
    ...
    /* Mantener los dos botones del Mercado Oculto lado a lado en el móvil */
    [data-testid="stHorizontalBlock"] > [data-testid="stColumn"]:last-child [data-testid="stHorizontalBlock"] {
        flex-direction: row !important; 
    }
    
    .market-card-img-wrap {
        height: 160px; /* Imágenes ligeramente más bajas en móvil */
    }
}
</style>
